...
import Practica2.Punto; // Importa aquí la clase Punto
...
public class LineaPoligonalPruebas01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Añadimos el punto " + p + "...");
        miLinea.añadir(p);
        verificaResultado(miLinea, "(0.00, 0.00)--(10.00, 0.00)--(0.00, 10.00)--(0.00, 0.00)", 34.14213562373095);

        System.out.println("Trasladamos 100 unidades en X y 100 en Y...");
        miLinea.trasladar(100, 100);
        verificaResultado(miLinea, "(100.00, 100.00)--(110.00, 100.00)--(100.00, 110.00)--(100.00, 100.00)",
                34.14213562373095);

        System.out.println("Quitamos el primer punto...");
        miLinea.quitar(0);
        verificaResultado(miLinea, "(110.00, 100.00)--(100.00, 110.00)--(100.00, 100.00)", 24.14213562373095);
    ...
    public static void verificaResultado(LineaPoligonal l, String resultadoCorrecto, double longitudCorrecta) {
        ...
        if (miResultado.equals(resultadoCorrecto) && Math.abs(miLongitud - longitudCorrecta) < 1E-6) {
            ...
            System.out.println("  INCORRECTO: Debería ser  " + resultadoCorrecto + " con longitud " + longitudCorrecta);
        }
        System.out.println();
    }
}*/
